...
window.addEventListener("load", function(){
    ...
    mobile = (parseInt(window.innerHeight) < 1000);
    if(mobile){
    document.getElementById("pdf_view_src").style.width = "";
    document.getElementById("img_view_src").style.width = "";
...
var opaque_value = ""; //GENERATE ON LOAD AFTER MOBILE TEST
